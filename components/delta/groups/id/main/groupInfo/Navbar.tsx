  ...
  return (
    <Grid className="px-3 py-2 h-full flex justify-start text-textLight dark:text-textDark">
        <Grid className="flex items-center gap-3">
               <IconButton onClick={()=> dispatch({type: sidebarTypes.CHANGE_SIDEBAR_STATE, payload: {showGroupInfo: false}})} className="text-textLight dark:text-textDark focus:outline-none hover:bg-bgButton dark:hover:bg-bgButtonDark" >
                    <CloseIcon/>
                </IconButton>
                <Typography className="p-0 ">Group Info</Typography>
        </Grid>
    </Grid>
  )
}
