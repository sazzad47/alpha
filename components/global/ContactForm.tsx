...
const items = [
  ...
  { id: 3, icon: <PhoneIcon />, title: "Phone", description: "02222200000" },
          ...
          <Grid item sm={12} md={6}>
            ...
            <form>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <button className="focus:outline-none border-none px-3 py-2 bg-pink-800 hover:bg-pink-700 text-slate-50 rounded">
                    Send
                  </button>
                </Grid>
              </Grid>
          ...
          <Grid item sm={12} md={6} className=" text-slate-50 font-serif">
            ...
            >
              ...
              <p className="text-sm font-semibold pl-0 mt-4">
                ...
                pas simplement du texte aléatoire.
              </p>
