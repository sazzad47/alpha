...
const menus = [
  { id: 1, icon: <SmartDisplayIcon />, name: "Beta", path: "/beta" },
  { id: 2, icon: <OfflineBoltIcon />, name: "Gamma", path: "/gamma" },
  { id: 3, icon: <WhatsAppIcon />, name: "Delta", path: "/delta" },
  { id: 4, icon: <TravelExploreIcon />, name: "Epsilon", path: "/epsilon" },
  { id: 5, icon: <BusinessCenterIcon />, name: "Zeta", path: "/zeta" },
  { id: 6, icon: <AssessmentIcon />, name: "Eta", path: "/eta" },
];
