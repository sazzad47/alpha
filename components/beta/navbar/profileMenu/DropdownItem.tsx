...
export default function DropdownItem(props: any) {
    return (
      <Link href="#" className="menu_item_beta_drop hover:bg-bgLightHover dark:hover:bg-bgDarkHover px-4" onClick={() => props.goToMenu && props.setActiveMenu(props.goToMenu)}>
